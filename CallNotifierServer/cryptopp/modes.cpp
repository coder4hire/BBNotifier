...
void CFB_ModePolicy::TransformRegister()
{
	...
	memmove_s2(m_register, m_register.size(), m_register+m_feedbackSize, updateSize);
	memcpy_s2(m_register+updateSize, m_register.size()-updateSize, m_temp, m_feedbackSize);
}
