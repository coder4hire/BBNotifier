...
inline void memcpy_s2(void *dest, size_t sizeInBytes, const void *src, size_t count)
{
...
inline void memmove_s2(void *dest, size_t sizeInBytes, const void *src, size_t count)
{
	if (count > sizeInBytes)
...
inline void ConditionalByteReverse(ByteOrder order, T *out, const T *in, size_t byteCount)
{
	if (!NativeByteOrderIs(order))
		...
		memcpy_s2(out, byteCount, in, byteCount);
}
...
inline void GetUserKey(ByteOrder order, T *out, size_t outlen, const byte *in, size_t inlen)
{
	...
	memcpy_s2(out, outlen*U, in, inlen);
...
{
	T value = 0;
	memcpy_s2(&value, sizeof(value), str.data(), UnsignedMin(str.size(), sizeof(value)));
	return NativeByteOrderIs(order) ? value : ByteReverse(value);
}
